...
// of children that were satisfied
	...
	public static void main(String[] args) {
		...
		/*
		 * Time Complexity: O(N logN + M logM + M) where N is the length of the greedy
		 * array, M is the length of the cookies array. To sort the greedy and cookies
		 * array, the complexity is O(N logN) and O(M logM).
		 * 
